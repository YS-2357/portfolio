...
## Repo-wide rules
- `AGENTS.md`: global agent rules, commit behavior, restrictions.
- `SKILLS.md`: skill index and one-line descriptions.

## Architecture & routing
- `reference/architecture/system-overview.md`: routes, content roots, asset paths.
